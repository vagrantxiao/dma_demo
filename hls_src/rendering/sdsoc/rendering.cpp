...
#pragma HLS INTERFACE ap_hs port=Output_1
  ...
  OUTPUT_FB_COL_pre: for ( bit16 j = 4; j < MAX_Y; j = j + 4)
  {
#pragma HLS PIPELINE II=4
  ...
  OUTPUT_FB_ROW: for ( bit16 i = 1; i < MAX_X; i++)
  {
...
#pragma HLS INTERFACE ap_hs port=Output_1
  ...
  {
    bit32 input_lo  = Input_1.read();
    bit32 input_mi  = Input_1.read();
    bit32 input_hi  = Input_1.read();
...
#pragma HLS INTERFACE ap_hs port=Output_1
	...
	{
#pragma HLS PIPELINE II=1
		 Output_1.write(MAX_PKT_LEN*NUMBER_OF_PACKETS*8/DATA_WIDTH+i);
	}
