...
#
# project_syn_gen.tcl: Tcl script for re-creating project 'dma_demo'
#
# Generated by Vivado on Thu May 14 22:31:46 EDT 2020
...
#
# 1. This project restoration tcl script (project_syn_gen.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/ylxiao/ws_183/F200513/dma_demo/dma_demo.srcs/sources_1/imports/src/AxiLite2Bft_v2_0.v"
#    "/home/ylxiao/ws_183/F200513/dma_demo/dma_demo.srcs/sources_1/imports/src/data_recv.v"
#    "/home/ylxiao/ws_183/F200513/dma_demo/dma_demo.srcs/sources_1/imports/src/data_send.v"
#    "/home/ylxiao/ws_183/F200513/dma_demo/dma_demo.srcs/sources_1/imports/src/converter.v"
#    "/home/ylxiao/ws_183/F200513/dma_demo/dma_demo.srcs/sources_1/imports/src/floorplan_static_wrapper.v"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/home/ylxiao/ws_183/F200513/src/ip2DMA.v"
#
#*****************************************************************************************
...
set script_file "project_syn_gen.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/dma_demo"]"
...
set files [list \
 ...
 [file normalize "${origin_dir}/src/data_recv.v"]\
 [file normalize "${origin_dir}/src/data_send.v"]\
...
set_property -name "top_auto_set" -value "0" -objects $obj
set_property -name "top_file" -value "$proj_dir//home/ylxiao/ws_183/F200513/dma_demo/home/ylxiao/ws_183/F200405_DMA_102/src/AxiLite2Bft_v2_0.v" -objects $obj
...
if { [get_files AxiLite2Bft_v2_0.v] == "" } {
  import_files -quiet -fileset sources_1 /home/ylxiao/ws_183/F200513/dma_demo/dma_demo.srcs/sources_1/imports/src/AxiLite2Bft_v2_0.v
}
if { [get_files data_recv.v] == "" } {
  import_files -quiet -fileset sources_1 /home/ylxiao/ws_183/F200513/dma_demo/dma_demo.srcs/sources_1/imports/src/data_recv.v
}
if { [get_files data_send.v] == "" } {
  import_files -quiet -fileset sources_1 /home/ylxiao/ws_183/F200513/dma_demo/dma_demo.srcs/sources_1/imports/src/data_send.v
}
if { [get_files converter.v] == "" } {
  import_files -quiet -fileset sources_1 /home/ylxiao/ws_183/F200513/dma_demo/dma_demo.srcs/sources_1/imports/src/converter.v
}
if { [get_files ip2DMA.v] == "" } {
  import_files -quiet -fileset sources_1 /home/ylxiao/ws_183/F200513/src/ip2DMA.v
}
...
# module references:
# AxiLite2Bft_v2_0, data_recv, data_send, dma_converter, ip2DMA
  ...
  # Create instance: data_recv_0, and set properties
  set block_name data_recv
  set block_cell_name data_recv_0
  if { [catch {set data_recv_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $data_recv_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: data_send_0, and set properties
  set block_name data_send
  set block_cell_name data_send_0
  if { [catch {set data_send_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $data_send_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net AxiLite2Bft_v2_0_0_ap_start [get_bd_pins AxiLite2Bft_v2_0_0/ap_start] [get_bd_pins data_send_0/ap_start]
  connect_bd_net -net AxiLite2Bft_v2_0_0_saxi_ready [get_bd_pins AxiLite2Bft_v2_0_0/saxi_ready] [get_bd_pins data_recv_0/Output_1_V_V_ap_ack]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tdata [get_bd_pins axi_dma_0/m_axis_mm2s_tdata] [get_bd_pins data_recv_0/Input_1_V_V]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tvalid [get_bd_pins axi_dma_0/m_axis_mm2s_tvalid] [get_bd_pins data_recv_0/Input_1_V_V_ap_vld]
  connect_bd_net -net axi_dma_0_s_axis_s2mm_tready [get_bd_pins data_send_0/Output_1_V_V_ap_ack] [get_bd_pins dma_converter_0/ready] [get_bd_pins ip2DMA_0/ready]
  connect_bd_net -net data_recv_0_Input_1_V_V_ap_ack [get_bd_pins axi_dma_0/m_axis_mm2s_tready] [get_bd_pins data_recv_0/Input_1_V_V_ap_ack]
  connect_bd_net -net data_recv_0_Output_1_V_V [get_bd_pins AxiLite2Bft_v2_0_0/saxi_data_in] [get_bd_pins data_recv_0/Output_1_V_V]
  connect_bd_net -net data_recv_0_Output_1_V_V_ap_vld [get_bd_pins AxiLite2Bft_v2_0_0/saxi_valid] [get_bd_pins data_recv_0/Output_1_V_V_ap_vld]
  connect_bd_net -net data_send_0_Output_1_V_V [get_bd_pins data_send_0/Output_1_V_V] [get_bd_pins dma_converter_0/dout] [get_bd_pins ip2DMA_0/dout]
  connect_bd_net -net data_send_0_Output_1_V_V_ap_vld [get_bd_pins axi_dma_0/s_axis_s2mm_tvalid] [get_bd_pins data_send_0/Output_1_V_V_ap_vld] [get_bd_pins dma_converter_0/valid] [get_bd_pins ip2DMA_0/valid]
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins AxiLite2Bft_v2_0_0/s00_axi_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn]
  connect_bd_net -net rst_ps8_0_99M_peripheral_reset [get_bd_pins data_recv_0/ap_rst] [get_bd_pins data_send_0/ap_rst] [get_bd_pins dma_converter_0/reset] [get_bd_pins ip2DMA_0/reset] [get_bd_pins rst_ps8_0_99M/peripheral_reset]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins data_recv_0/ap_start] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins AxiLite2Bft_v2_0_0/s00_axi_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins data_recv_0/ap_clk] [get_bd_pins data_send_0/ap_clk] [get_bd_pins dma_converter_0/clk] [get_bd_pins ip2DMA_0/m_axis_mm2s_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  ...
  create_bd_addr_seg -range 0x10000000 -offset 0xE0000000 [get_bd_addr_spaces axi_dma_0/Data_SG] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_PCIE_LOW] SEG_zynq_ultra_ps_e_0_HP0_PCIE_LOW
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xA0001000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs AxiLite2Bft_v2_0_0/s00_axi/reg0] SEG_AxiLite2Bft_v2_0_0_reg0
...
#  -string -flagsOSRD
preplace inst dma_converter_0 -pg 1 -lvl 2 -y -110 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 2 -y 610 -defaultsOSRD
preplace inst rst_ps8_0_99M -pg 1 -lvl 4 -y -60 -defaultsOSRD
preplace inst ps8_0_axi_periph -pg 1 -lvl 5 -y -110 -defaultsOSRD
preplace inst data_send_0 -pg 1 -lvl 1 -y 50 -defaultsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 2 -y 350 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 2 -y -630 -defaultsOSRD
preplace inst ip2DMA_0 -pg 1 -lvl 2 -y 80 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 5 -y -540 -defaultsOSRD
preplace inst data_recv_0 -pg 1 -lvl 2 -y -480 -defaultsOSRD
preplace inst AxiLite2Bft_v2_0_0 -pg 1 -lvl 3 -y -410 -defaultsOSRD
preplace netloc dma_converter_0_last 1 1 2 -160 -220 460
preplace netloc AxiLite2Bft_v2_0_0_ap_start 1 0 4 -680 -310 N -310 N -310 930
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 5 -690 160 -250 -320 590 610 950 -160 1390
preplace netloc axi_dma_0_m_axis_mm2s_tdata 1 1 2 -180 -360 500
preplace netloc axi_smc_M00_AXI 1 1 5 -210J -340 570J -510 960J -440 NJ -440 1730
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 2 3 NJ 580 930 -220 N
preplace netloc axi_dma_0_M_AXI_SG 1 2 3 530J -570 N -570 1400
preplace netloc dma_converter_0_keep 1 1 2 -170 -230 480
preplace netloc rst_ps8_0_99M_peripheral_aresetn 1 1 4 -200J -290 600J -290 N -290 1400
preplace netloc axi_dma_0_m_axis_mm2s_tvalid 1 1 2 -170 -350 510
preplace netloc ps8_0_axi_periph_M01_AXI 1 2 4 610J -300 NJ -300 NJ -300 1730
preplace netloc data_send_0_Output_1_V_V_ap_vld 1 1 1 -220
preplace netloc axi_dma_0_s_axis_s2mm_tready 1 0 3 -670 -50 -260 -240 490
preplace netloc axi_dma_0_M_AXI_MM2S 1 2 3 550 -560 NJ -560 NJ
preplace netloc xlconstant_0_dout 1 1 2 -160 -690 580
preplace netloc data_recv_0_Input_1_V_V_ap_ack 1 2 1 520J
preplace netloc ps8_0_axi_periph_M00_AXI 1 1 5 -190J -280 NJ -280 NJ -280 NJ -280 1720
preplace netloc data_send_0_Output_1_V_V 1 1 1 -230
preplace netloc data_recv_0_Output_1_V_V_ap_vld 1 2 1 560
preplace netloc axi_dma_0_M_AXI_S2MM 1 2 3 580 -540 NJ -540 NJ
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 2 2 N 620 960
preplace netloc ip2DMA_0_m_axis_mm2s 1 1 2 -180 -210 470
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM1_FPD 1 2 3 NJ 600 940 -200 N
preplace netloc rst_ps8_0_99M_peripheral_reset 1 0 5 -660 150 -240J -250 NJ -250 N -250 1380
preplace netloc data_recv_0_Output_1_V_V 1 2 1 600
preplace netloc AxiLite2Bft_v2_0_0_saxi_ready 1 1 3 -160J -370 540J -520 930
levelinfo -pg 1 -710 -460 150 770 1200 1570 1750 -top -890 -bot 1410
"
}
...
wait_on_run impl_1
file mkdir ./${_xil_proj_name_}/${_xil_proj_name_}.sdk
file copy -force ./${_xil_proj_name_}/${_xil_proj_name_}.runs/impl_1/floorplan_static_wrapper.sysdef ./${_xil_proj_name_}/${_xil_proj_name_}.sdk/floorplan_static_wrapper.hdf
