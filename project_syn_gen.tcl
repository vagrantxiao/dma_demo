...
#
# project_syn_gen1.tcl: Tcl script for re-creating project 'dma_demo'
#
# Generated by Vivado on Fri May 15 20:32:12 EDT 2020
...
#
# 1. This project restoration tcl script (project_syn_gen1.tcl) that was generated.
#
...
set script_file "project_syn_gen1.tcl"
...
if { [get_files converter.v] == "" } {
  import_files -quiet -fileset sources_1 /home/ylxiao/ws_183/F200513_git/dma_demo/dma_demo.srcs/sources_1/imports/src/converter.v
}
if { [get_files ip2DMA.v] == "" } {
  import_files -quiet -fileset sources_1 /home/ylxiao/ws_183/F200513_git/src/ip2DMA.v
}
if { [get_files pseudo_rendering.v] == "" } {
  import_files -quiet -fileset sources_1 /home/ylxiao/ws_183/F200513_git/src/pseudo_rendering.v
}
...
# module references:
# AxiLite2Bft_v2_0, dma_converter, ip2DMA, pseudo_rendering
  ...
  # Create instance: pseudo_rendering_0, and set properties
  set block_name pseudo_rendering
  set block_cell_name pseudo_rendering_0
  if { [catch {set pseudo_rendering_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $pseudo_rendering_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net AxiLite2Bft_v2_0_0_ap_start [get_bd_pins AxiLite2Bft_v2_0_0/ap_start] [get_bd_pins pseudo_rendering_0/ap_start]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tdata [get_bd_pins axi_dma_0/m_axis_mm2s_tdata] [get_bd_pins pseudo_rendering_0/Input_1_V_V]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tvalid [get_bd_pins axi_dma_0/m_axis_mm2s_tvalid] [get_bd_pins pseudo_rendering_0/Input_1_V_V_ap_vld]
  ...
  connect_bd_net -net ip2DMA_0_ready [get_bd_pins dma_converter_0/ready] [get_bd_pins ip2DMA_0/ready] [get_bd_pins pseudo_rendering_0/Output_1_V_V_ap_ack]
  connect_bd_net -net pseudo_rendering_0_Input_1_V_V_ap_ack [get_bd_pins axi_dma_0/m_axis_mm2s_tready] [get_bd_pins pseudo_rendering_0/Input_1_V_V_ap_ack]
  connect_bd_net -net pseudo_rendering_0_Output_1_V_V [get_bd_pins dma_converter_0/dout] [get_bd_pins ip2DMA_0/dout] [get_bd_pins pseudo_rendering_0/Output_1_V_V]
  connect_bd_net -net pseudo_rendering_0_Output_1_V_V_ap_vld [get_bd_pins dma_converter_0/valid] [get_bd_pins ip2DMA_0/valid] [get_bd_pins pseudo_rendering_0/Output_1_V_V_ap_vld]
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_reset [get_bd_pins dma_converter_0/reset] [get_bd_pins ip2DMA_0/reset] [get_bd_pins pseudo_rendering_0/ap_rst] [get_bd_pins rst_ps8_0_99M/peripheral_reset]
